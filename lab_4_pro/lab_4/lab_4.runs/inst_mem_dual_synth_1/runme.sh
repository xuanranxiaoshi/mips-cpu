...
HD_PWD='F:/IDE/Vivado/HardwareDesign/step_into_mips-lab_4/lab_4/lab_4/lab_4.runs/inst_mem_dual_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_mem_dual.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inst_mem_dual.tcl
